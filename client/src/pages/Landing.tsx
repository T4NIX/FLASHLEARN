    ...
    <div className="min-h-screen bg-background selection:bg-primary/20">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            >
              Upload any document and instantly get summaries, flashcards, and
              quizzes. Master any subject with personalized AI tutoring.
            </motion.p>
            ...
            >
              <Button
                size="lg"
                className="h-14 px-8 text-lg rounded-full shadow-xl shadow-primary/25 hover:shadow-2xl hover:shadow-primary/30 transition-all hover:-translate-y-1"
                onClick={goToLogin}
              >
      ...
      <footer className="py-12 border-t border-border">
        <div className="container mx-auto px-4 text-center text-muted-foreground">
          <p>© 2026 FlashLearn. Built by Tanishk with curiosity ☕</p>
        </div>
      </footer>
    </div>
  );
